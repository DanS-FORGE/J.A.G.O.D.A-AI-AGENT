...
sidebar_position: 1
title: "Architecture"
description: "J.A.G.O.D.A internals — major subsystems, execution paths, data flow, and where to read next"
---

# Architecture

This page is the top-level map of J.A.G.O.D.A internals. Use it to orient yourself in the codebase, then dive into subsystem-specific docs for implementation details.
...
Exposes J.A.G.O.D.A as an editor-native agent over stdio/JSON-RPC for VS Code, Zed, and JetBrains.
