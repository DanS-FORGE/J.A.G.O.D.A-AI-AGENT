...
J.A.G.O.D.A tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. J.A.G.O.D.A resolves them through:
