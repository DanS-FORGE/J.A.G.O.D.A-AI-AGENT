...
description: "Install and deploy J.A.G.O.D.A with Nix — from quick `nix run` to fully declarative NixOS module with container mode"
---
...
J.A.G.O.D.A ships a Nix flake, a NixOS module, and a Home Manager module.
