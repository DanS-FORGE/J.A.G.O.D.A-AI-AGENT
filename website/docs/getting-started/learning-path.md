...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the J.A.G.O.D.A documentation based on your experience level and goals.'
---

# Learning Path

J.A.G.O.D.A can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed J.A.G.O.D.A yet, begin with the [Installation guide](/getting-started/installation) and then run through the [Quickstart](/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything J.A.G.O.D.A can do.
...
Use J.A.G.O.D.A as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. J.A.G.O.D.A can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy J.A.G.O.D.A as a bot on your favorite messaging platform.
...
:::tip
Cron jobs let J.A.G.O.D.A run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::
...
Extend J.A.G.O.D.A with your own tools and reusable skill packages.
...
Use reinforcement learning to fine-tune model behavior with J.A.G.O.D.A's RL training pipeline (powered by [Atropos](https://github.com/NousResearch/atropos)).
...
:::tip
RL training works best when you already understand the basics of how J.A.G.O.D.A handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate J.A.G.O.D.A into your own Python applications programmatically.
