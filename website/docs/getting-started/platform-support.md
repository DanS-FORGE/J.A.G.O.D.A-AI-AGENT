...
description: "Which operating systems, distribution methods, and features J.A.G.O.D.A supports."
---

# Platform Support

J.A.G.O.D.A maintains support for many platforms and distribution methods, but we can't support every possible install method.
