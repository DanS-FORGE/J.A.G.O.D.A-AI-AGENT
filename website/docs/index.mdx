...
slug: /
sidebar_position: 0
title: "J.A.G.O.D.A Documentation"
...
To easily install the command-line and desktop applications, [download the J.A.G.O.D.A Desktop installer](https://hermes-agent.nousresearch.com/) from our website and run it.

### Without J.A.G.O.D.A Desktop:

For a command-line only install without J.A.G.O.D.A Desktop, run:
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend J.A.G.O.D.A safely  |
| 🧭 **[Use MCP with J.A.G.O.D.A](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with J.A.G.O.D.A](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for J.A.G.O.D.A voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define J.A.G.O.D.A's default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of J.A.G.O.D.A                              |
