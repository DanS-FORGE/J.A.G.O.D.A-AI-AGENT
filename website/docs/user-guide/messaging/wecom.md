...
description: "Connect J.A.G.O.D.A to WeCom via the AI Bot WebSocket gateway"
---

# WeCom (Enterprise WeChat)

Connect J.A.G.O.D.A to [WeCom](https://work.weixin.qq.com/) (企业微信), Tencent's enterprise messaging platform. The adapter uses WeCom's AI Bot WebSocket gateway for real-time bidirectional communication — no public endpoint or webhook needed.
...
Select **WeCom** and scan the QR code with your WeCom mobile app. J.A.G.O.D.A will automatically create a bot application with the correct permissions and save the credentials.
