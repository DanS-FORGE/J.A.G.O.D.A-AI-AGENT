---
sidebar_position: 30
title: "J.A.G.O.D.A Relay"
description: "Connect J.A.G.O.D.A to messaging platforms through a relay connector that owns the platform credentials — enrollment, capabilities, config, and troubleshooting"
---

# J.A.G.O.D.A Relay (Connector)
...
J.A.G.O.D.A Relay is not a chat platform itself — it is a **connector system** that
