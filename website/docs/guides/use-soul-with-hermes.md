---
sidebar_position: 7
title: "Use SOUL.md with Jagoda"
description: "How to use SOUL.md to shape Jagoda's default voice, what belongs there, and how it differs from AGENTS.md and /personality"
---

# Use SOUL.md with Jagoda

`SOUL.md` is the **primary identity** for your J.A.G.O.D.A instance. It's the first thing in the system prompt — it defines who the agent is, how it speaks, and what it avoids.

If you want Jagoda to feel like the same assistant every time you talk to it — or if you want to replace the Jagoda persona entirely with your own — this is the file to use.
...
- personality
- communication style
- how direct or warm Jagoda should be
- what Jagoda should avoid stylistically
- how Jagoda should relate to uncertainty, disagreement, and ambiguity

In short:
- `SOUL.md` is about who Jagoda is and how Jagoda speaks
...
J.A.G.O.D.A now uses only the global SOUL file for the current instance:

```text
~/.hermes/SOUL.md
```

If you run J.A.G.O.D.A with a custom home directory, it becomes:
...
J.A.G.O.D.A automatically seeds a starter `SOUL.md` for you if one does not already exist.

That means most users now begin with a real file they can read and edit immediately.

Important:
- if you already have a `SOUL.md`, J.A.G.O.D.A does not overwrite it
- if the file exists but is empty, J.A.G.O.D.A adds nothing from it to the prompt

## How J.A.G.O.D.A uses it

When J.A.G.O.D.A starts a session, it reads `SOUL.md` from `HERMES_HOME`, scans it for prompt-injection patterns, truncates it if needed, and uses it as the **agent identity** — slot #1 in the system prompt. This means SOUL.md completely replaces the built-in default identity text.
...
That alone can noticeably change how Jagoda feels.
...
Jagoda already tries to be helpful and clear. `SOUL.md` should add real personality and style, not restate obvious defaults.
...
# Style
How Jagoda should sound.

# Avoid
What Jagoda should not do.

# Defaults
How Jagoda should behave when ambiguity appears.
```
...
Then restart J.A.G.O.D.A or start a new session.
...
### I edited SOUL.md but Jagoda still sounds the same
...
### Jagoda is ignoring parts of my SOUL.md
