...
┌───────────────────────────────────────────────────────────────────┐
│                                                                   │
│   Cron Timer  ──▶  J.A.G.O.D.A  ──▶  GitHub API  ──▶  Review     │
...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](./webhook-github-pr-review.md) — GitHub pushes events to J.A.G.O.D.A instantly when PRs are opened or updated.
:::
...
- **J.A.G.O.D.A installed** — see the [Installation guide](/getting-started/installation)
...
Make sure J.A.G.O.D.A can access GitHub. Start a chat:
...
Still in the chat, ask J.A.G.O.D.A to review a real PR:
...
A skill gives J.A.G.O.D.A consistent review guidelines that persist across sessions and cron runs. Without one, review quality varies.
...
This is what makes the reviewer actually useful. Start a session and teach J.A.G.O.D.A your team's standards:
...
2. Teach J.A.G.O.D.A your conventions via memory (Step 4)
