...
description: "How the J.A.G.O.D.A Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the J.A.G.O.D.A Desktop app connects to a **gated gateway** (a hosted or
...
For J.A.G.O.D.A specifically, native sign-in means:
...
- [Run J.A.G.O.D.A with Nous Portal](./run-hermes-with-nous-portal.md)
