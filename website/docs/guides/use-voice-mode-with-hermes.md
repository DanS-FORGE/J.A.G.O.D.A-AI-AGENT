---
sidebar_position: 8
title: "Use Voice Mode with J.A.G.O.D.A"
description: "A practical guide to setting up and using J.A.G.O.D.A voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with J.A.G.O.D.A
...
- you want J.A.G.O.D.A sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in J.A.G.O.D.A.
...
## Step 1: make sure normal J.A.G.O.D.A works first
...
J.A.G.O.D.A supports both local and cloud speech stacks.
...
4. J.A.G.O.D.A transcribes and responds
...
- asking J.A.G.O.D.A to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full J.A.G.O.D.A loop.

## Tuning CLI behavior

### Silence threshold

If J.A.G.O.D.A starts/stops too aggressively, tune:
...
J.A.G.O.D.A stays a normal chat bot, but can speak replies.
...
- you want J.A.G.O.D.A to function like a portable research or ops assistant
...
J.A.G.O.D.A joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- J.A.G.O.D.A detects speech boundaries
- transcripts are posted in the associated text channel
- J.A.G.O.D.A responds in text and audio
...
1. get text J.A.G.O.D.A working
