...
description: "Reference for J.A.G.O.D.A core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call J.A.G.O.D.A tools programmatically. |
