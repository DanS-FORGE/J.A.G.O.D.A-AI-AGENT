...
# Configuration
REPO_URL_SSH="git@github.com:DanS-FORGE/JAGODA-AI-AGENT.git"
REPO_URL_HTTPS="https://github.com/DanS-FORGE/JAGODA-AI-AGENT.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/DanS-FORGE/JAGODA-AI-AGENT/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
