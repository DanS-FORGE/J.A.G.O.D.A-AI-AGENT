# Política de Seguridad de J.A.G.O.D.A

Este documento describe el modelo de confianza de J.A.G.O.D.A, identifica el
...
vulnerabilidades de seguridad. **J.A.G.O.D.A no opera un programa de
...
J.A.G.O.D.A es un agente personal de un solo inquilino. Su postura es
...
- **Proceso del agente.** El intérprete Python que ejecuta J.A.G.O.D.A,
...
- **Envolvente de confianza.** El conjunto de recursos a los que un operador ha otorgado
  implícitamente acceso a J.A.G.O.D.A al ejecutarlo — típicamente, todo lo que
  la propia cuenta de usuario del operador puede alcanzar en el host.
- **Postura.** Una declaración explícita en la documentación o código de J.A.G.O.D.A
...
J.A.G.O.D.A admite dos posturas de aislamiento a nivel de SO. Abordan
...
J.A.G.O.D.A admite esto de dos maneras:

- **La propia imagen Docker de J.A.G.O.D.A y la configuración de Compose.** Más
...
Bajo una envoltura de proceso completo, las heurísticas en proceso de J.A.G.O.D.A
...
J.A.G.O.D.A filtra el entorno que pasa a sus componentes en proceso de
...
Un plugin malicioso o con errores no es una vulnerabilidad en J.A.G.O.D.A
en sí mismo. Los errores en la ruta de instalación o descubrimiento de plugins de J.A.G.O.D.A
...
4. **Dentro del conjunto autorizado, todos los llamadores tienen la misma confianza.**
   J.A.G.O.D.A no modela capacidades por llamador dentro de un único adaptador.
...
- Violaciones de la documentación del modelo de confianza: código que se comporta
  contrariamente a lo que esta política, la propia documentación de J.A.G.O.D.A o
  las expectativas razonables del operador predecirían — incluyendo casos donde
  J.A.G.O.D.A ha documentado una postura sobre cómo su salida debe ser
...
- **Habilidades y plugins contribuidos por la comunidad.** Las habilidades de terceros
  ...
  están en la superficie de revisión del operador, no en la superficie de confianza de J.A.G.O.D.A
  (§2.4, §2.5). Una habilidad o plugin que haga algo
  malicioso es el modo de falla esperado de uno que no fue
  revisado, no una vulnerabilidad en J.A.G.O.D.A. Los errores en la ruta de
  instalación de habilidades o plugins de J.A.G.O.D.A que impidan al
...
- J.A.G.O.D.A incluye guardias de cadena de suministro para lanzamientos de servidores
