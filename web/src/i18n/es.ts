...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateHermes: "Actualizar J.A.G.O.D.A",
    updatingHermes: "Actualizando J.A.G.O.D.A…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de J.A.G.O.D.A (equivalente a `hermes plugins`).",
  ...
  env: {
    ...
    customHint: "Variables de entorno arbitrarias almacenadas en tu .env que J.A.G.O.D.A no reconoce. Úsalas para inyectar variables de entorno para skills, servidores MCP o tus propias herramientas.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de J.A.G.O.D.A ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de J.A.G.O.D.A. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa J.A.G.O.D.A más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que Jagoda detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "J.A.G.O.D.A está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
