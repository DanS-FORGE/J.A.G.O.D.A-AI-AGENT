...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateHermes: "Aggiorna J.A.G.O.D.A",
    updatingHermes: "Aggiornamento di J.A.G.O.D.A…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin J.A.G.O.D.A (parità con `hermes plugins`).",
  ...
  env: {
    ...
    customHint: "Variabili d'ambiente arbitrarie salvate nel tuo .env che J.A.G.O.D.A non riconosce. Usale per iniettare variabili d'ambiente per skill, server MCP o i tuoi strumenti.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge J.A.G.O.D.A da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni J.A.G.O.D.A in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa J.A.G.O.D.A di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Jagoda rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "J.A.G.O.D.A sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
