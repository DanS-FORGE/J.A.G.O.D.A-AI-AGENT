...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "J.A.G.O.D.A Teal",
  description: "Classic dark teal — the canonical J.A.G.O.D.A look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "J.A.G.O.D.A Teal (Large)",
  description: "J.A.G.O.D.A Teal with bigger fonts and roomier spacing",
