...
version: 1.0.1
author: Joe Rinaldi Johnson (joerj123), Jagoda
license: MIT
...
| Telegram (J.A.G.O.D.A + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
