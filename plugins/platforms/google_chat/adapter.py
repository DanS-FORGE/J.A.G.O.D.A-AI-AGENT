...
#     fresh "Jagoda is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # they don't sit in the chat forever as "Jagoda is thinking…".
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'Jagoda is thinking…' marker message.
        ...
        "Jagoda is thinking…" stuck in chat forever, plus one card that
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "Jagoda is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "Jagoda is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "Jagoda is thinking…" card during any subsequent
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # the "Jagoda is thinking..." marker patches and edit overhead.
        ...
        platform_hint=(
            ...
            "are generating a response, a 'Jagoda is thinking…' marker message "
