...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your J.A.G.O.D.A session")
        ...
        @tree.command(name="status", description="Show J.A.G.O.D.A session status")
        ...
        @tree.command(name="stop", description="Stop the running J.A.G.O.D.A agent")
        ...
        @tree.command(name="update", description="Update J.A.G.O.D.A to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="restart", description="Gracefully restart the J.A.G.O.D.A gateway")
        ...
        @tree.command(name="thread", description="Create a new thread and start a J.A.G.O.D.A session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to J.A.G.O.D.A in the thread",
    ...
    def _register_skill_group(self, tree) -> None:
        ...
        try:
            ...
            cmd = discord.app_commands.Command(
                name="skill",
                description="Run a J.A.G.O.D.A skill",
    ...
    async def rename_thread(
        ...
        *,
        ...
        if edit is None:
            return False
        try:
            await edit(name=cleaned, reason="J.A.G.O.D.A semantic session title")
            logger.info(
    ...
    async def create_handoff_thread(
        ...
        reason = "J.A.G.O.D.A session handoff"
    ...
    async def send_exec_approval(
        ...
        try:
            ...
            prompt_prefix = (
                ...
                "Do you want Jagoda to run this command?\n\n"
                "**Requested command:**\n```bash\n"
            )
            if smart_denied:
    ...
    async def send_clarify(
        ...
        try:
            ...
            content = self._self_contained_prompt_content(
                "❓ **Jagoda needs your input**", str(question or "").strip(),
                tail=clarify_tail,
            )
                ...
                if thread:
                    ...
                    try:
                        await message.channel.send(
                            "⚠️ Jagoda could not create a Discord thread for "
...
def interactive_setup() -> None:
    ...
    print()
    print_info("📬 Home Channel: where Jagoda delivers cron job results,")
