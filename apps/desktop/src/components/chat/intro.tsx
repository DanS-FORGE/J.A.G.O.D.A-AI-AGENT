...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should J.A.G.O.D.A look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} J.A.G.O.D.A need to see?`,
    ...
    {
      headline: `What should ${label} J.A.G.O.D.A tackle?`,
