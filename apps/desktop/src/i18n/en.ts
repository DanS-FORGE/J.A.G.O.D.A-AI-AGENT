...
export const en: Translations = {
  ...
  boot: {
    ready: 'J.A.G.O.D.A Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading J.A.G.O.D.A settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote J.A.G.O.D.A backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting J.A.G.O.D.A Desktop…'
    },
    errors: {
      backgroundExited: 'J.A.G.O.D.A background process exited.',
      backgroundExitedDuringStartup: 'J.A.G.O.D.A background process exited during startup.',
    ...
    failure: {
      title: "J.A.G.O.D.A couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your J.A.G.O.D.A backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update J.A.G.O.D.A',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting J.A.G.O.D.A Desktop.',
    ...
    native: {
      ...
      inputBody: 'Jagoda is waiting for your response.',
      turnDoneTitle: 'Jagoda finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to J.A.G.O.D.A defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the J.A.G.O.D.A backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the J.A.G.O.D.A backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while J.A.G.O.D.A is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Jagoda asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while J.A.G.O.D.A was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while J.A.G.O.D.A was in the background.'
        }
      },
      test: 'Send test notification',
      testTitle: 'J.A.G.O.D.A',
    ...
    searchPlaceholder: {
      about: 'About J.A.G.O.D.A Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let J.A.G.O.D.A follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Jagoda can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Jagoda when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Jagoda walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Jagoda is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen J.A.G.O.D.A, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'J.A.G.O.D.A Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The J.A.G.O.D.A runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'J.A.G.O.D.A checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading J.A.G.O.D.A configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening J.A.G.O.D.A.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every J.A.G.O.D.A gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      kindSsh: 'SSH',
      kindLocalDesc: 'The J.A.G.O.D.A runtime managed by this app.',
      kindRemoteDesc: 'A J.A.G.O.D.A gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Hermes Cloud account.',
      kindSshDesc: 'A J.A.G.O.D.A install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers J.A.G.O.D.A manages (Authorization, Cookie, Host…) are ignored.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a J.A.G.O.D.A backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private J.A.G.O.D.A backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote J.A.G.O.D.A backend.',
      ...
      restartingMessage: 'J.A.G.O.D.A Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · J.A.G.O.D.A ${version}` : ''}`,
      ...
      sshDesc:
        'J.A.G.O.D.A is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — J.A.G.O.D.A runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'J.A.G.O.D.A is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Hermes path.',
      sshErrPlatform:
        'Unsupported remote platform. J.A.G.O.D.A Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update J.A.G.O.D.A on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to J.A.G.O.D.A. Review the exact configuration below — it comes from the link, not from J.A.G.O.D.A.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. J.A.G.O.D.A runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point J.A.G.O.D.A at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Jagoda builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart J.A.G.O.D.A to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update J.A.G.O.D.A to generate pets.',
      backgroundHint: 'You can close this — Jagoda will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure J.A.G.O.D.A desktop' },
    ...
    hermesActiveSessions: (version, count) => `J.A.G.O.D.A ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent J.A.G.O.D.A environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'J.A.G.O.D.A did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Jagoda will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the J.A.G.O.D.A backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from J.A.G.O.D.A. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the J.A.G.O.D.A backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting J.A.G.O.D.A...',
    placeholderReconnecting: 'Reconnecting to J.A.G.O.D.A…',
    ...
    attachUrlDesc: 'Jagoda will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Jagoda to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating J.A.G.O.D.A…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting J.A.G.O.D.A…',
    ...
    unsupportedMessage: 'This version of J.A.G.O.D.A can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of J.A.G.O.D.A is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected J.A.G.O.D.A backend is ready to install.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the J.A.G.O.D.A desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The J.A.G.O.D.A updater takes over in its own window and reopens J.A.G.O.D.A automatically when it’s done. Please don’t reopen J.A.G.O.D.A yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. J.A.G.O.D.A reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then J.A.G.O.D.A reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update J.A.G.O.D.A?',
    blockerBody:
      'J.A.G.O.D.A needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update J.A.G.O.D.A',
    foreignBlockerBody:
      'J.A.G.O.D.A can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'J.A.G.O.D.A can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'J.A.G.O.D.A needs a one-time install',
    ...
    setupChoiceTitle: 'Set up J.A.G.O.D.A Desktop',
    setupChoiceDesc:
      'Connect this app to a J.A.G.O.D.A gateway you already run, or install J.A.G.O.D.A locally on this computer.',
    connectExistingTitle: 'Connect to existing J.A.G.O.D.A',
    ...
    installLocalTitle: 'Install J.A.G.O.D.A locally',
    ...
    probeError: 'Could not reach that J.A.G.O.D.A gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up J.A.G.O.D.A',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with J.A.G.O.D.A",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'J.A.G.O.D.A is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting J.A.G.O.D.A…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run J.A.G.O.D.A',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — J.A.G.O.D.A connects automatically',
    ...
    authorizeThere: 'Authorize J.A.G.O.D.A there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize J.A.G.O.D.A there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `J.A.G.O.D.A Desktop v${version}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. J.A.G.O.D.A will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Jagoda is restarting...',
      askRestart: 'Ask Jagoda to restart the server',
      lookingRestart: taskId => `Jagoda is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Jagoda is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Jagoda to open a page.',
      finishedRestarting: message => `Jagoda finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Jagoda could not restart the server.',
      stillWorking:
        'Jagoda is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Jagoda is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'J.A.G.O.D.A gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Jagoda won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Jagoda needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Jagoda needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart J.A.G.O.D.A Desktop to use Save Image.',
    restartToSaveImages: 'Restart J.A.G.O.D.A Desktop to save images',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Jagoda loads when the work calls for them.'
      },
      messaging: {
        title: 'Jagoda away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Jagoda made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Jagoda — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
