...
export const ar = defineLocale({
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل J.A.G.O.D.A Desktop.',
  ...
  updates: {
    ...
    blockerBody:
      'يحتاج J.A.G.O.D.A إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.',
  ...
  onboarding: {
    ...
    autoBrowser: provider =>
      `فتحنا ${provider} في المتصفح. صرّح لـ J.A.G.O.D.A هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
