# Contributing to J.A.G.O.D.A

Thank you for contributing to J.A.G.O.D.A! This guide covers everything you need: setting up your dev environment, understanding the architecture, deciding what to build, and getting your PR merged.
...
4. **`author` credits the human contributor first.** For external contributions, the contributor's real name + GitHub handle goes first (`Jane Doe (jane-doe)`); "Jagoda" is the secondary collaborator. If the contributor's commit shows "Jagoda" as author because they used Jagoda to draft the skill, replace it with their actual name — credit the human, not the tool.
