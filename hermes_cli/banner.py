...
_UPSTREAM_REPO_URL = "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI-AGENT.git"
_OFFICIAL_REPO_CANONICAL = "github.com/dans-forge/j.a.g.o.d.a-ai-agent"
...
def _github_compare_behind(current_rev: str, target_rev: str) -> Optional[int]:
    ...
    if not (_is_full_sha(current_rev) and _is_full_sha(target_rev)):
        return None
    url = (
        "https://api.github.com/repos/dans-forge/j.a.g.o.d.a-ai-agent/"
...
_RELEASE_URL_BASE = "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI-AGENT/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    J.A.G.O.D.A checkout. Cached per-process. Release URL always points at
    the canonical DanS-FORGE/J.A.G.O.D.A-AI-AGENT repo (forks don't get a link).
    """
...
def format_banner_version_label() -> str:
    ...
    base = f"J.A.G.O.D.A v{VERSION} ({RELEASE_DATE})"
