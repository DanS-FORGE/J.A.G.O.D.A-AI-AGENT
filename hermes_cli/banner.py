...
_UPSTREAM_REPO_URL = "https://github.com/DanS-FORGE/JAGODA-AI-AGENT.git"
_OFFICIAL_REPO_CANONICAL = "github.com/dans-forge/jagoda-ai-agent"
...
def _github_compare_behind(current_rev: str, target_rev: str) -> Optional[int]:
    ...
    if not (_is_full_sha(current_rev) and _is_full_sha(target_rev)):
        return None
    url = (
        "https://api.github.com/repos/dans-forge/jagoda-ai-agent/"
...
_RELEASE_URL_BASE = "https://github.com/DanS-FORGE/JAGODA-AI-AGENT/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    the canonical DanS-FORGE/JAGODA-AI-AGENT repo (forks don't get a link).
    """
